...
{\small
  \begin{tblr}{rl}
    \textbf{Email:}  & \mail{jaeho.lee@snu.ac.kr} \\
...
\begin{tblr}{Xr}
  ...
  \SetCell[c=2]{l} Leave of absence for military duty during 2020--2021                                               \\[0.5\onelineskip]
  \textbf{Korea Science Academy of KAIST} (KSA)                               & Busan, Korea                          \\
  {\small\textit{Graduated; GPA: 4.05/4.3}}                                   & \textit{Mar 2015--Feb 2018}           \\
  High school for gifted students, KSA Fund Scholarship                                                               \\
\end{tblr}
...
\begin{tblr}{Xr}
  ...
  \SetCell[c=2]{l} \textbullet\ Escape analysis of \texttt{unsafe} Rust (Ongoing work)                                                                                              \\[0.5\onelineskip]
