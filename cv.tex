...
% \Entry{
%   date     = {Fall 2025},
%   title    = {SNU M1522.007600 Computing Overview},
% }

\Entry{
  date     = {Spring 2025},
  title    = {SNU 4190.664A Program Analysis},
  position = {Outstanding Teaching Assistant Award (currently nominated)},
}
...
\Entry{
  ...
  body     = {PL reading group with participants from \textit{Programming Research Laboratory at Seoul National University} and \textit{Programming Research Group at the Institute of Science Tokyo.} Tuesday every week at \qty{2}{PM} KST/JST.},
}
\vspace{0.5\onelineskip}
