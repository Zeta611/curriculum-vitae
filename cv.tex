...
\textbf{Korean}~(native, 1999), \textbf{English}~(fluent, 2006), \textbf{Spanish}~(elementary, 2022)

\vfill\hfill \textit{Last updated on \today~(using \LaTeX3{} on Vim \& NixOS/macOS btw).}
\end{document}
