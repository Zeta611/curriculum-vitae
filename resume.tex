...
\begin{tblr}{Xr}
  ...
  \SetCell[c=2]{l} \textbullet\ Retargeting an Abstract Interpreter for a New Language by Partial Evaluation                                                                        &                             \\
  \SetCell[c=2]{l} \quad \textsmaller{Ongoing research}                                                                                                                             &                             \\
  \SetCell[c=2]{l} \textbullet\ \textsc{React-tRace}: A Semantics for Understanding React Hooks (\github{Zeta611/react-trace})                                               &                             \\
  \SetCell[c=2]{l} \quad \textsmaller{Submitted to OOPSLA '25}                                                                                                                      &                             \\
  \SetCell[c=2]{l} \textbullet\ STAPPL: Statically Typed Probabilistic Programming Language (\github{Zeta611/stappl})                                                               &                             \\
  \SetCell[c=2]{l} \quad \textsmaller{Final project for a graduate course on Probabilistic Graphical Models (ranked top-3)}                                                         &                             \\
  ...
  \SetCell[c=2]{l} \textbullet\ Prospect analysis of programs with holes (\github{Zeta611/L})                                                                                       &                             \\ [0.5\onelineskip]
  ...
  \SetCell[c=2]{l} \quad\textbullet\ Attended Intel International Science and Engineering Fair (ISEF) 2017 as a finalist                                                            &                             \\
...
\begin{tblr}{Xr}
  ...
  \SetCell[c=2]{l} {Title: The Next Generation Multi-Robot Exploration: Biased Viewpoint Sampling via Dynamic     &                             \\
...
\begin{tblr}{Xr}
  ...
  \SetCell[c=2]{l} \quad Received the best TA award           \\
