...
\begin{tblr}{Xr}
  ...
  \SetCell[c=2]{l} \textbullet\ Static analysis of React programs and formalization of the React hooks (Ongoing work)                                                               \\
  \SetCell[c=2]{l} \textbullet\ Uncaught exception analysis on \href{https://rescript-lang.org/}{ReScript}                                                                          \\
  \SetCell[c=2]{l} \textbullet\ Prospect analysis of programs with a hole (\url{https://github.com/Zeta611/L})
  \\[0.5\onelineskip]
